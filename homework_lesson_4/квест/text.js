var works = {
    ...
    d00: 'Вы решили подождать обед в столовой.\n' +
    'На столе вы замечаете письмо с надписью на конверте: не вскрывать, и вы решаете...\n',
    d0: 2, // кол-во ответов
    d1: '1 - Открыть письмо\n',
    d2: '2 - Сжечь письмо в камине, не открывая\n',
};
